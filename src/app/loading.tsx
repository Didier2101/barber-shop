    ...
    >
      ...
      <section className="relative z-10 h-full flex items-center justify-center px-4">
        <div className="w-full max-w-md rounded-3xl border border-white/15 bg-transparent p-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#f59e0b] rounded-2xl shadow-lg mb-6 animate-pulse">
            <Scissors size={28} className="text-black" />
          </div>
          <p className="text-[10px] uppercase tracking-[0.32em] text-[#f59e0b] mb-3">Cargando</p>
          <h1 className="text-white text-3xl font-black leading-tight uppercase">Preparando tu experiencia</h1>
          <p className="text-white/70 text-sm mt-4">Un momento por favor...</p>
        </div>
      </section>
    </main>
  );
