    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
      <div className="relative">
        ...
        <motion.div
          ...
          className="w-16 h-16 border-4 border-white/5 border-t-[#f59e0b] rounded-full shadow-[0_0_20px_rgba(245,158,11,0.2)]"
        />
        <motion.div
      ...
      <div className="space-y-2 text-center">
        <p className="text-[#f59e0b] text-[10px] font-black uppercase tracking-[0.4em] animate-pulse">Sincronizando Agenda</p>
        <div className="flex gap-1 justify-center">
          <motion.div animate={{ opacity: [0.2, 1, 0.2] }} transition={{ repeat: Infinity, duration: 1, delay: 0 }} className="w-1 h-1 bg-white rounded-full" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mt-12 opacity-20 blur-sm pointer-events-none">
         <div className="bg-white/5 h-40 rounded-[2rem]" />
         <div className="bg-white/5 h-40 rounded-[2rem]" />
      </div>
    </div>
  );
